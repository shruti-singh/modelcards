...
model2contextlength = {
    ...
    # 32768
    "lmsys/longchat-7b-v1.5-32k": ("longchat_7b_32k", 16384, "https://huggingface.co/lmsys/longchat-7b-v1.5-32k/blob/main/tokenizer_config.json"),
...
def model_response_gen(model_name):
    ...
    for _, dockey in enumerate(qa_data):
        ...
        # doc_path = "/home/singh_shruti/workspace/rep_learning/ldb_ranking/retriever" + dockey[1:]
